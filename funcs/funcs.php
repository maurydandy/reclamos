<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = 'maury.606@gmail.com'; //Modificar correo emisor
		$mail->Password = 'stsspass'; //Modificar pasword correo emisor
		
		$mail->setFrom('maury.606@gmail.com', 'Sistema de Usuarios'); //Modificar correo emisor nombre del correo
