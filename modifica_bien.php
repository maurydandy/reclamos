...
//if( isset( $_GET['idt'])) {
 //   $idt = $_GET['idt']; 
	$sql= "SELECT * FROM bines_baja WHERE id = '$id'";
...
<script src="http://code.jquery.com/ui/1.10.1/jquery-ui.js"></script>
	...
	<body>
		<div class="container">
			<div class="row">
				<h3 style="text-align:center">MODIFICACION DE BIENES DE BAJA</h3>
			</div>
...
<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="cupi" class="form-control" id="cupi" name="cupi" placeholder="CUPI" value="<?php echo $row['cupi']; ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="serie" class="form-control" id="serie" name="serie" placeholder="serie" value="<?php echo $row['serie']; ?>">
					</div>
				</div>
					<P>
					<div class="form">
			<label for="detalle" class="col-sm-2 control-label">DETALLE:</label>
				<textarea name="detalle" rows="10" cols="40" id="detalle"><?php echo $row['detalle']; ?></textarea>					
		</div>
				</P>
    ...
    $.datepicker.setDefaults($.datepicker.regional['es']);
		...
		<div class="form-group">
					...
					<div class="col-sm-2">
						...
						<select class="form-control" id="funciona" name="funciona">
							<option ><?php echo $row['funciona']; ?> </option>
							<option value=""></option>
		...
		<div class="form">
			<label for="detalle" class="col-sm-2 control-label">FALLA/ROTURA:</label>
				<textarea name="falla" rows="10" cols="40" id="falla"><?php echo $row['falla']; ?></textarea>					
		</div>
		</p>
		...
		<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<select class="form-control" id="retirado" name="retirado">
							<option ><?php echo $row['retirado']; ?> </option>
							<option value=""></option>
