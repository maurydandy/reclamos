...
<script src="http://code.jquery.com/ui/1.10.1/jquery-ui.js"></script>
	...
	<body>
		<div class="container">
			<div class="row">
				<h3 style="text-align:center">MODIFICACION DE RECLAMOS</h3>
			</div>
			...
			<form class="form-horizontal" method="POST" action="update2.php" autocomplete="off">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="" class="form-control" id="persona" name="persona" placeholder="Solicitante" value="<?php echo $row['persona']; ?>">
					</div>
				</div>
		...
		<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<select class="form-control" id="personal" name="personal">
							<option ><?php echo $row['personal']; ?> </option>
    ...
    $.datepicker.setDefaults($.datepicker.regional['es']);
		...
		<input type="fechat" class="form-control" id="datepicker1" name="fechat" placeholder="Fecha Turno" value="<?php echo $row['fechat']; ?>">
			...
			<div class="form-group">
					...
					<div class="col-sm-1">
						<input type="text" class="form-control" id="horat" name="horat" placeholder="hora" value="<?php echo $row['horat']; ?>">
					</div>
				</div>

				<div class="form-group">
					<label for="" class="col-sm-2 control-label">Finalizado:</label>
					<div class="col-sm-2">
						
						<select class="form-control" id="terminado" name="terminado">
							<option ><?php echo $row['terminado']; ?> </option>
							<option value=""></option>
