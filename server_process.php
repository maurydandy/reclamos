<?php
	...
	*/
	...
	$aColumnas = array( 'id','persona','oficina','fecha', 'hora','detalle','fechat', 'horat', 'terminado', 'personal');					
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar2.php?id=".$aRow['id']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
